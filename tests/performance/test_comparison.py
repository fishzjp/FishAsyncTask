...
class TestPerformanceComparison:
    ...
    def test_cleanup_performance_comparison(self, task_manager):
        ...
        improvement = (
            (baseline_cleanup_time_ms - current_cleanup_time_ms) / baseline_cleanup_time_ms * 100
        )
    ...
    def test_end_to_end_comparison(self, task_manager):
        ...
        execution_improvement = (
            (baseline_execution_time - execution_time) / baseline_execution_time * 100
        )
        query_improvement = (
            (baseline_query_p99 - current_results["query_p99_ms"]) / baseline_query_p99 * 100
        )
